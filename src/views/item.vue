				...
				<div class="item-box">
					<div class="gallery-wrapper">
						<div class="gallery">
							<div class="thumbnail">
								<ul>
									<li :class="{'on':index == imgIndex}" v-for="images,index in itemInfo.ali_images">
                     <img :src="images+'?x-oss-process=image/resize,w_54/quality,Q_90/format,webp'">
                  </li>
								</ul>
							</div>
							<div class="thumb">
								<ul>
									<li :class="{'on':index == imgIndex}" v-for="images,index in itemInfo.ali_images">
                     <img :src="images+'?x-oss-process=image/resize,w_440/quality,Q_90/format,webp'">
                  </li>
								</ul>
							</div>
						</div>
							...
							<div class="sku-dynamic-params clear">
								...
								<ul class="params-colors">
									<li class="cur" v-for="color,index in itemInfo.sku_list">
										<a :title="color.color">
                      <img :src="'http://img01.smartisanos.cn/'+color.image+'20X20.jpg?x-oss-process=image/resize,w_36/quality,Q_90/format,webp'" :alt="color.color">
                      </a>
									</li>
								</ul>
							</div>
							<div class="sku-dynamic-params clear">
								...
								<div class="params-detail clear">
									<div class="item-num js-select-quantity">
										...
										<span class="num">{{ itemInfo.limit_num }}</span>
